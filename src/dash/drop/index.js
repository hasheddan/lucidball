...
export default class Drop extends React.Component {
    ...
    render() {
        ...
        return(
            <div onMouseEnter={this.showTeams} onMouseLeave={this.showTeams} style={{ height: "80%", position: "relative", left: "5%", top: "60%", transform: "translateY(-50%)", display: "block"}}>
                <h1 style={{ borderBottomStyle: "solid", top: "100%", marginBottom: "0", width: "100%" }}>{this.state.value}</h1>
                {list}
            </div>
        );
    }
